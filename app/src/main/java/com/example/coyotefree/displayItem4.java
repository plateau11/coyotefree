...
public class displayItem4 extends AppCompatActivity {
    String text_key;
    ...
    public void decryptModified(String text_key, String filename) throws Exception {
        ...
        String newFileName = "modified_doc"; // New file name without extension
        String newPath = changeFileName(originalPath, newFileName);
        ...
        if(check==true){
            //Toast.makeText(this, "Doc file created successfully", Toast.LENGTH_SHORT).show();
            //first logic using intent ppt viewer
            Intent intent = new Intent(displayItem4.this, All_Document_Reader_Activity.class);
