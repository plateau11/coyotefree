...
public class displayItem5 extends AppCompatActivity {
    String text_key ;
    String newPath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_item5);
        text_key = "";
        /** new security code **/
    ...
    public void decryptModified(String text_key, String filename) throws Exception {
        ...
        String newFileName = "modified_ppt"; // New file name without extension
        ...
        if (check == true) {
            ...
            Intent intent = new Intent(displayItem5.this, All_Document_Reader_Activity.class);
